...
on a newly installed machine where the packages where not installed in the same order than on the master, hence having
...
network-mounted filesystems and such, if any. The script does it best to do this for you, but you should ensure
